...
<div id="dropdownNotification"
    class="z-20 hidden w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow-sm absolute top-16 right-16"
    ...
    <div class="divide-y divide-gray-100">
        ...
        @endif
        @empty
        <p class=" text-xs text-gray-500  p-5 text-center">Not found any notification yet.</p>
        @endforelse
